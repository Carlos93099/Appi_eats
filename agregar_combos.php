<div class="modal-header">
    <h4 class="modal-title" id="myModalLabel">Agregar combos </h4>
</div>
<div class="modal-body">
    <form class="form-horizontal form-label-left input_mask" method="post" id="add" name="add">
        <div id="result"></div>
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nombre del combo
            </label>
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Productos
            </label>
            <div class="col-md-9 col-sm-9 col-xs-12">
                <input type="text">
            </div>
